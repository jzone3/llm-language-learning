          ...
          hero={
            <>
              ...
              <p className="mt-6 text-lg text-neutral-600 leading-relaxed">
                Every morning we message you a bite-size quiz of the words you&apos;re about to
                forget, plus a couple of new ones — words, phrases, and slang, scheduled by a real
