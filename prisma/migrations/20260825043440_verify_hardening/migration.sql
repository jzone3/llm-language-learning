...
INSERT INTO "new_User" ("cadenceNotes", "createdAt", "id", "language", "lastAnsweredAt", "name", "newWordsPerDay", "optedOut", "phone", "secondSendHour", "sendHour", "streak", "timezone", "verified", "verifyCode") SELECT "cadenceNotes", "createdAt", "id", "language", "lastAnsweredAt", "name", "newWordsPerDay", "optedOut", "phone", "secondSendHour", "sendHour", "streak", "timezone", "verified", "verifyCode" FROM "User";
DROP TABLE "User";
